...
Tofu_HANDLER = CommandHandler("Tofu", Tofu, run_async=True)
...
TofuNSFW_HANDLER = CommandHandler("Tofunsfw", Tofunsfw, run_async=True)
...
dispatcher.add_handler(Tofu_HANDLER)
...
dispatcher.add_handler(TofuNSFW_HANDLER)
...
*Commands* `*:*  
   ➢ `/Tofu`*:*Sends Random SFW Tofu source Images.
