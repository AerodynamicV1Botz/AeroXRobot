...
import TofuXrobot.modules.sql.connection_sql as sql
from TofuXrobot import dispatcher, DRAGONS, DEV_USERS
from TofuXrobot.modules.helper_funcs import chat_status
