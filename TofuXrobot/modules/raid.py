...
from .helper_funcs.decorators import Tofucmd, Tofucallback
...
@Tofucmd(command="raid", pass_args=True)
@bot_admin
@connection_status
@loggable
...
@Tofucallback(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@Tofucallback(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@Tofucallback(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@Tofucmd(command="raidactiontime", pass_args=True)
@connection_status
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
